...
//             sx={{ margin: 0, padding: 0 }} 
//           >
//             <Typography>Pre-Committee Review</Typography>
//           </DialogTitle>
//         </Box>
//         <DialogContent>
//           <Grid container spacing={2}>
...
//                 size="small"
//                 variant="outlined"
//                 value={selectedItem?.PreCommitteeComments || ""}
//                 InputProps={{ readOnly: true }}
//               />
//             </Grid>
//             <Grid item xs={12} sm={6}>
...
//                 size="small"
//                 variant="outlined"
//                 value={selectedItem?.PreCommitteeChange || ""}
//                 InputProps={{ readOnly: true }}
//               />
//             </Grid>
//           </Grid>
...
//                 size="small"
//                 variant="outlined"
//                 value={committeechangesRequired}
//                 onChange={(e) => setCommitteeChangesRequired(e.target.value)}
//               />
//             </Grid>
//           </Grid>
//         </DialogContent>
...
//             variant="contained"
//             sx={{ marginRight: 1, backgroundColor: "#E1255A" }}
//           >
//             Accept
//           </Button>
//           <Button
        ...
        <DialogContent>
          {sections.map((section, index) => (
            <Box key={index} sx={{ marginBottom: 2 }}>
              <Typography variant="h6" sx={{ backgroundColor: "#E1255A", color: "white", padding: 1, marginBottom: 2 }}>
                {section.title}
              </Typography>
              <Grid container spacing={2}>
